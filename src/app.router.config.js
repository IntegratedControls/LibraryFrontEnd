  ...
  configure(config, router){
    let theAppRouterConfig = function(config){
      ...
      config.map([
        ...
        { route: 'login', name: 'login', moduleId: './login', nav: false, title: 'Login', icon: 'fa-sign-in', settings: 'fa fa-sign-in'},
        ...
        { route: 'news', name: 'news', moduleId: './news', nav: true, title: 'Release Notes', settings: 'fa fa-file-text-o'}
      ]);
    };
